...
import {
  default as DlpCarouselImage1,
  default as DlpCarouselImage2,
  default as DlpCarouselImage3,
  default as SiemCarouselImage1,
  default as SiemCarouselImage2,
  default as SiemCarouselImage3,
} from "@/assets/images/product-carousel-images/dlp/dlp-carousel-1.png";
import {
  default as DlpFeatureIcon2,
  default as SiemFeatureIcon2,
} from "@/assets/images/product-feature-icons/alarm-warning.svg";
  ...
  const data =
    product === "dlp"
      ? {
          ...
          url: "updive-dlp.uz",
          images: [DlpCarouselImage1, DlpCarouselImage2, DlpCarouselImage3],
        }
      : {
          ...
          url: "updive-siem.uz",
          images: [SiemCarouselImage1, SiemCarouselImage2, SiemCarouselImage3],
        };
